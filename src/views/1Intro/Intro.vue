<template>
  <section id="intro">
    ...
    <!-- <div id="fourmile-photos" class="flex-container">
      <div class="flex-item">
        <img 
          id="aerial-1" 
          src="@/assets/images/NASAEO/boulder_ali_2011158_lrg.jpg" 
          alt=""
        >
        <p class="caption">
      ...
      <div class="flex-item">
        <img 
          id="aerial-4" 
          src="@/assets/images/NASAEO/fourmilecanyon_ali_2010259_lrg.jpg" 
          alt=""
        >
        <p class="caption">
          Watershed after fire
