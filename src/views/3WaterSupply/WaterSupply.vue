<template>
  <section id="water-supply-section">
      ...
      <div class="flex-item">
        <picture>
          ...
          <img 
            ...
            v-img:group-3 
            src="@/assets/components/water-supply/diagrams/beforeFire_1200w.jpg" 
      ...
      <div class="flex-item">
        <picture>
          ...
          <img 
            ...
            v-img:group-3 
            src="@/assets/components/water-supply/diagrams/afterFire_1200w.jpg" 
    ...
    <div class="text-content">
      <p><a href="https://agupubs.onlinelibrary.wiley.com/doi/full/10.1002/2016WR019110" target="_blank">Wildfires short-circuit these sponge and filter functions.</a>  A wildfire burns the vegetation and leaf litter on the forest floor, causing more rainfall to directly fall on the soil surface.  Heat from the wildfire redistributes organic substances in vegetation and soil, making the soil hydrophobic (“water-hating”). Impacts from soil heating also make the soil less porous and less able to soak up rainfall. Thus, after a wildfire burns through a landscape, much of the rainfall does not soak into the soil, but instead moves over the surface rapidly as “overland flow.”</p>
      <p>This rapidly moving water can pick up and <a href="https://iopscience.iop.org/article/10.1088/1748-9326/10/8/084007" target="_blank">carry the wildfire ash and sediment into streams.</a> Heavy rains can even lead to destructive <a href="https://landslides.usgs.gov/hazards/postfire_debrisflow/" target="_blank">debris flows.</a> Formerly clean, clear streams become clogged with ash, sediment, and burned materials. In forests that have been impacted by other disturbances, such as air pollution or mining, nutrient and <a href="https://www.sciencedirect.com/science/article/pii/S0048969720341577?via%3Dihub" target="_blank">metal concentrations</a> can also increase as the overland flow mobilizes more material. These watershed changes pose challenges for water managers, who then must use additional treatments and incur extra costs before this water can be used for municipal water supply.</p>
    </div>
  </section>
</template>
